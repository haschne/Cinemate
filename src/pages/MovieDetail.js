...
export const MovieDetail = () => {
  ...
  useTitle(movie.title); //update page Title

  useEffect(() => {
    async function fetchMovie(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=ca21c0f0b6b007cf9a8d24b7a7b43f86`);
        ...
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
          ...
          <p className="my-4">{movie.overview}</p>        
            ...
            <p className="my-4">
              ...
              <a href={`https://www.imdb.com/title/${movie.imdb_id}`} className="text-blue-300 underline hover:underline-offset-4" target="_blank" rel="noreferrer">{movie.imdb_id}</a>
            </p>
